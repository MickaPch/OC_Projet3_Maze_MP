...
class Game:
    ...
    def on_init(self, file):
        ...
        self.maze.on_init(self.game_map)
        ...
        while self._running:
            ...
            if self.maze.player.position == self.maze.guardian.position:
                if not self.maze.bag.full:
                    ...
                    guardian_position = self.maze.blit_item(self.maze.guard, self.maze.guardian.position)
                    ...
                    for element in self.maze.list_guardian_animation:
                        self.maze.blit_item(element, self.maze.guardian.position)
                    guardian_position = self.maze.blit_item(self.maze.macgyver, self.maze.guardian.position)
                    pygame.display.update(guardian_position)
